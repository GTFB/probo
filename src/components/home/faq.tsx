...
const faqs = [
  {
    ...
    answer:
      "tweakcn is a visual theme editor for probo/ui components with Tailwind CSS support. It comes with a set of pre-built themes that you can use to customize your project.",
  },
  {
  ...
  {
    question: "How do I customize a probo/ui theme?",
    answer:
      "You can customize a probo/ui theme by selecting the a preset theme you want to use from the dropdown menu and then adjusting the colors to you liking. Once you are happy with the theme, you can export the code by either copying it or running the command to apply the theme to your project automatically.",
  },
  {
  ...
  {
    question: "Can I use tweakcn with my existing probo/ui project?",
    answer:
      "Yes, tweakcn is designed to work with existing probo/ui projects. You can export the generated code by either copying it or running the command to apply the theme to your project automatically.",
  },
  {

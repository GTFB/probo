    ...
    <div className="flex items-center flex-wrap gap-2">
      {colors.map((color) => (
        <CheckboxPrimitive.Root
          ...
          className={cn("h-8 w-8 rounded-full border-2 border-transparent focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50", {

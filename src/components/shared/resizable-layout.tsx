...
export function ResizableLayout({
  ...
  const [isLeftVisible, setIsLeftVisible] = useState(leftSectionState !== 'close')
  const [isRightVisible, setIsRightVisible] = useState(rightSectionState !== 'close')
  ...
  const mainSize = isLeftVisible && isRightVisible 

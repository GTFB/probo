...
graph TD
    ...
    subgraph "Облачная инфраструктура (Kubernetes / Docker Compose)"
        LB[Load Balancer]
...
graph TD
    ...
    C -- Нет --> G((Сборка провалена. Уведомление в Slack));
```
